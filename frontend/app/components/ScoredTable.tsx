  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 border-b border-gray-200 text-[11px] font-semibold text-gray-500 uppercase tracking-wide">
        ...
        <span className="w-16 sm:w-20 text-right hidden sm:block">Real</span>
        <span className="w-20 text-right hidden sm:block">Predito</span>
        <span className="w-16 sm:w-20 text-right">Variação</span>
        <span className="w-8 sm:w-10 text-right">iCO</span>
        <span className="w-7 sm:w-24 text-right"><span className="hidden sm:inline">Status</span></span>
      </div>
